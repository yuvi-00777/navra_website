  ...
  const services = [
    {
      ...
      icon: (
        <svg className="w-12 h-12 text-[#c8a96a]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <section className="services-hero">
        ...
        <div className="container services-hero__content">
          ...
          <h1 className="services-hero__title">
            For <span className="text-[#c8a96a]">Startups</span>
          </h1>
          ...
          <div className="services-hero__actions">
            <Link to="/about" className="services-hero__btn services-hero__btn--primary">Get Started</Link>
          </div>
        </div>
      </section>

      {/* Business Type Section */}
      <section className="services-section bg-gray-50">
        <div className="container">
          <h2 className="services-section__title">What’s Your Business?</h2>
          <div className="flex flex-col sm:flex-row justify-center gap-6 mt-8">
            <button className="business-type-btn">
              <span className="w-4 h-4 rounded-full border-2 border-[#c8a96a] mr-2"></span>
        ...
        <div className="container">
          ...
          <div className="services-grid">
            {services.map((service, index) => (
              <Link to={service.path} key={index} className="service-card group">
                <div className="service-card__icon mb-4 group-hover:scale-110 transition-transform duration-300">
                  {service.icon}
                </div>
                <h3 className="service-card__title text-xl font-bold text-gray-800 group-hover:text-[#c8a96a] transition-colors">
                  {service.title}
                </h3>
                </Link>
            ))}
